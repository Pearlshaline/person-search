  ...
  const exampleConversations = [
    {
      ...
      tool: 'list_persons()',
      result: '[{ id: 1, firstName: "Pearl", lastName: "Gumiran", email: "pearl@gmail.com", ... }]',
    },
    {
      user: 'Add a new person: John Doe, john@example.com, age 25',
      claude: 'Creating a new person record using the create_person MCP tool.',
      tool: 'create_person({ firstName: "John", lastName: "Doe", email: "john@example.com", age: 25 })',
      result: '{ id: 2, firstName: "John", lastName: "Doe", email: "john@example.com", age: 25, createdAt: "..." }',
    },
    {
      user: 'Delete the person with ID 2',
      claude: 'I\'ll remove that record using the delete_person MCP tool.',
      tool: 'delete_person({ id: 2 })',
